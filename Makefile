...
index.html: main.cc tilemap.cc buttons.cc game.cc hero.cc sprite.cc asset_dir
	em++ main.cc tilemap.cc buttons.cc game.cc hero.cc sprite.cc -std=c++17 -s WASM=1 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png"]' --preload-file asset_dir -o index.html
